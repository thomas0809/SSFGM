...
class GraphConvolution(Layer):
    ...
    def __init__(self, input_dim, output_dim, placeholders, dropout=0., index=None,
                 support=None, sparse_inputs=False, act=tf.nn.relu, bias=False, concat=False,
    ...
    def _call(self, inputs):
        ...
        if self.concat:
            pre_sup = dot(x, self.vars['weights_1'],
                          sparse=self.sparse_inputs)
            output += dot(self.index, pre_sup, sparse=True)
